...
export const hi = {
  ...
  'ai.departmentNotOnline':
    'अस्पताल में इसका इलाज होता है, पर ऑनलाइन बुकिंग उपलब्ध नहीं है — ये परामर्श रिसेप्शन तय करता है। {reception} पर कॉल कीजिए, वे सही डॉक्टर के साथ समय तय कर देंगे।\n\nअगर बात अत्यावश्यक है तो इंतज़ार न करें — सीधे कैज़ुअल्टी आ जाइए।',
  'ai.fallback':
