...
export const hi = {
  ...
  'reviews.subtitle': 'जिनकी हमने देखभाल की, उनके सच्चे शब्द।',
  'reviews.empty': 'अभी तक कोई समीक्षा नहीं — अपना अनुभव सबसे पहले साझा करें।',
  'reviews.outOf5': '5 में से {avg}',
  'reviews.count': '{count} समीक्षाएँ',
  'reviews.countOne': '1 समीक्षा',
  'reviews.verified': 'सत्यापित मरीज़',
  'reviews.with': '{doctor} के साथ',
  'reviews.leaveTitle': 'समीक्षा लिखें',
  'reviews.leaveCta': 'अपनी विज़िट की समीक्षा करें',
  'reviews.leavePrompt': 'आपकी विज़िट कैसी रही?',
  'reviews.ratingLabel': 'आपकी रेटिंग',
  'reviews.star': '{n} स्टार',
  'reviews.stars': '{n} स्टार',
  'reviews.commentLabel': 'अपनी विज़िट के बारे में बताएँ (वैकल्पिक)',
  'reviews.commentPlaceholder': 'क्या अच्छा रहा? क्या और बेहतर हो सकता था?',
  'reviews.nameLabel': 'मेरा नाम ऐसे दिखाएँ (वैकल्पिक)',
  'reviews.namePlaceholder': 'जैसे आशा के.',
  'reviews.submit': 'समीक्षा भेजें',
  'reviews.submitting': 'भेजा जा रहा है…',
  'reviews.thanks': 'धन्यवाद! हमारे स्टाफ़ की मंज़ूरी के बाद आपकी समीक्षा दिखाई देगी।',
  'reviews.errorGeneric': 'क्षमा करें, आपकी समीक्षा सहेजी नहीं जा सकी। कृपया फिर से कोशिश करें।',
  'reviews.chooseRating': 'कृपया एक स्टार रेटिंग चुनें।',
  'reviews.close': 'बंद करें',

  /* ---------- Attachments ---------- */
  'attach.label': 'फ़ोटो या रिपोर्ट जोड़ें (वैकल्पिक)',
  'attach.hint': 'तकलीफ़ की फ़ोटो, लैब रिपोर्ट या पुरानी पर्ची डॉक्टर को पहले ही समझने में मदद करती है। JPG, PNG या PDF, ज़्यादा से ज़्यादा 4 फ़ाइलें।',
  'attach.add': 'फ़ाइल जोड़ें',
  'attach.sending': 'भेजा जा रहा है\u2026',
  'attach.remove': '{name} हटाएँ',
  'attach.remaining': '{n} और जोड़ सकते हैं',
  'attach.full': 'यही अधिकतम है।',
  'attach.failed': 'वह फ़ाइल नहीं भेजी जा सकी। कृपया दूसरी आज़माएँ।',
  'attach.forDoctor': 'मरीज़ ने भेजा',

  /* ---------- Captcha ---------- */
  'captcha.label': 'बस यह जाँच रहे हैं कि आप एक व्यक्ति हैं',
  'captcha.hint': 'यह जोड़ हल कीजिए ताकि हमें पता चले कि आप कंप्यूटर नहीं हैं।',
  'captcha.aria': '{sum} कितना होता है?',
  'captcha.newSum': 'मुझे दूसरा सवाल दीजिए',
  'captcha.errorRequired': 'आगे बढ़ने के लिए कृपया सवाल का जवाब दें।',
  'captcha.errorWrong': 'वह जवाब सही नहीं था। कृपया नया सवाल हल कीजिए।',
  'captcha.errorExpired': 'उस सवाल की अवधि समाप्त हो गई। कृपया नए का जवाब दें।',
}
